...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 font-sans">
      <header className={`fixed w-full z-50 transition-all duration-300 ${scrollPosition > 50 ? 'bg-gray-900/90 backdrop-blur-md py-2' : 'bg-transparent py-4'}`}>
      ...
      <main className="pt-20">
        ...
        <WavyDotPattern className={`w-full`}/>
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <ConnectWallet
              style={{ backgroundColor: "rgb(22 163 74)", borderWidth: 0, fontSize: "1.25rem", borderRadius: "9999px", padding: "0.75rem 2rem"}}
              theme={"light"}
        ...
        <section id="features" className="py-20 bg-gray-800">
          <div className="container mx-auto px-4">
            <h3 className="text-4xl font-bold text-center mb-16 text-white">Why Choose CarbonDex?</h3>
        ...
        <section id="market-potential" className="py-20 bg-gray-800">
          <div className="container mx-auto px-4 text-center">
            <h3 className="text-4xl font-bold mb-12 text-white">Massive Market Potential</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-gray-700 p-8 rounded-lg shadow-lg">
                <h4 className="text-2xl font-semibold mb-4 text-green-400">India Market</h4>
                <p className="text-3xl font-bold text-white">$1.2 Billion</p>
              </div>
              <div className="bg-gray-700 p-8 rounded-lg shadow-lg">
                <h4 className="text-2xl font-semibold mb-4 text-green-400">Global Market</h4>
        ...
        <section id="contact" className="py-20 bg-gray-900 text-center">
          <div className="container mx-auto px-4">
            ...
            <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">Join CarbonDex today. Profit from sustainability and help create a greener future.</p>
